// captura_zoom.mjs — como captura_entropy_jugado.mjs pero con un recorte (clip) para
// mirar de cerca una zona concreta de la mesa.
import { spawn } from 'node:child_process';
import { chromium } from 'playwright-core';

const RAIZ = 'Q:\\alisa_project\\alisa\\World\\Synthesis\\Web\\alisa-systems';
const P = 8961;
const juego = process.argv[2] || 'remigio';
const destino = process.argv[3] || `Q:\\SystemRelief\\OscarTemp\\Active\\claude\\Q--\\248d4bf5-cde4-4dcd-902c-e80e4f2e9efa\\scratchpad\\captura_${juego}_zoom.png`;
...
const ctx = await navegador.newContext({ viewport: { width: 1280, height: 720 }, deviceScaleFactor: 2 });
...
await page.screenshot({ path: destino, clip: { x: 230, y: 230, width: 350, height: 140 } });
